...
export const DetailCard: React.FC<DetailCardProps> = ({
  ...
  return (
    <div
      className="w-full aspect-[3/4] p-10 flex flex-col transition-all duration-500 shadow-2xl relative overflow-hidden"
      style={{
    ...
    >
      <div
        className="flex-1 rounded-[3rem] p-10 flex flex-col shadow-inner relative overflow-hidden border border-white/10"
